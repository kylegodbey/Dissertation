...
\documentclass[aps,prc,twocolumn,showpacs,superscriptaddress,longbibliography,nofootinbib,floatfix,10pt]{revtex4-1}
...
%\title{The role of tensor force on heavy-ion interaction potential deduced from density-constraint time-dependent Hartree-Fock approach}
\title{The influence of tensor force on the microscopic heavy-ion interaction potential}

\author{Lu Guo} \email{luguo@ucas.ac.cn}
...
For light systems, the tensor force is found to have a small effect overall on the nucleus-nucleus potential. However, for medium and heavy spin-unsaturated reactions,
the potentials may change \textcolor{red} {by a fraction to several MeV} by the inclusion of tensor force, indicating a strong impact of the tensor force on sub-barrier fusion.
\item[Conclusions]
...
%and resonance dynamics~\cite{Simenel2001_PRL86-2971,
...
\begin{figure}
\includegraphics[width=8.6cm]{./data_figure/V1.pdf}
...
\begin{figure*}
\includegraphics[width=15.7cm]{./data_figure/V3_ppt.pdf}
...
\begin{figure}[t]
\includegraphics[width=8.6cm]{./data_figure/V5_Ca48Ca48.pdf}
...
\begin{figure}[t]
    \includegraphics[width=8.6cm]{./data_figure/V4_ppt.pdf}
